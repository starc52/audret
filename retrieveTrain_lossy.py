...
parser.add_argument('--loss_factor',default=0.5, type=float)
parser.add_argument('--log_interval',default=20, type=int)
parser.add_argument('--no_workers',default=40, type=int)
parser.add_argument('--log_path',default='/home/starc52/LearnablePINs_lossy/train_log_'+str(datetime.now().strftime("%Y-%m-%d_%H-%M-%S"))+"/", type=str)
parser.add_argument('--checkpoint_path',default="/ssd_scratch/cvit/starc52/LPscheckpoints_lossy/", type=str)
...
traindataset = simpleDataLoaderLossy(loss_factor, args.root, split='train')
